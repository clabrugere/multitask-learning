...
- encode the causal nature of the funnel: a conversion happens after a click, hence $` P\(click\) \geq P\(conversion\) `$. It can be encoded as a penalty term in the loss function.
